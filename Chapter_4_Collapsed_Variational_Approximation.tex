...
\includegraphics[scale=0.5]{code/QLT/results/highdimensional_covariates_logprob1.pdf}
\end{figure}
...
\includegraphics[scale=0.5]{code/QLT/results/highdimensional_likelihood_logprob1.pdf}
\end{figure}
...
\includegraphics[scale=0.5]{code/QLT/results/highdimensional_cold_logprob1.pdf}
\end{figure}
...
\includegraphics[scale=0.5]{code/QLT/results/QTL_covariates_maruyama.pdf}
...
\includegraphics[scale=0.5]{code/QLT/results/QTL_likelihood_maruyama.pdf}
\end{figure}
...
\includegraphics[scale=0.5]{code/QLT/results/QTL_cold_maruyama.pdf}
