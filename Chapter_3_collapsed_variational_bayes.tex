...
&= -\left[\frac{n + p}{2} + 1\right] \log \sigma^2  + \frac{1}{\sigma^2} - \frac{1}{2} \left[ \left(1 + \frac{1}{g} \right) [\vmu_{q(\vbeta)}^\top \mX^\top \mX \vmu_{q(\vbeta)} + \tr(\mX^\top \mX \mSigma_{q(\vbeta)})] + \vy^\top \mX \vmu_{q(\vbeta)}] \\
\end{align*}
