...
likelihood of the candidate models to see which is most probable. \cite{Goel1986} suggested a particular form
...
choosing a prior on $g$. Using a mixture of $g$-priors has the advantage of \ldots In this sense, the choice
of covariates for the optimal model selected can be considered to be automatic. This choice can be made while
inducing sparsity.
