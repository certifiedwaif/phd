...
the parameter space where the data is least informative.
...
\subsection{Hitters}
Source: \cite{James:2014:ISL:2517747}

Figure \ref{fig:Hitters_inclusion}
...
Figure \ref{fig:bodyfat_inclusion}
...
Figure \ref{fig:GradRate_inclusion}
...
Figure \ref{fig:USCrime_inclusion}
