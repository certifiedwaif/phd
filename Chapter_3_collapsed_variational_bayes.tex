...
Consider the model $\vy | \vbeta, \sigma^2 \sim N_n(\mX \text{diag}(\vgamma) \vbeta, \sigma^2 \mI)$ with
priors
\begin{equation*}
\begin{array}{ll}
\vbeta | \sigma^2, g &\sim N_p(\vzero, g \sigma^2(\mX^\top \text{diag}(\vgamma) \mX)^{-1}), \\
...
&= -\frac{n}{2} \log{2 \pi} -\half \log |\sigma^2 I_n| - \half (\vy - \mX \text{diag}(\vgamma) \vbeta)^\top \sigma^{-2} \mI_n (\vy - \mX \text{diag}(\vgamma) \vbeta) \\
...
& = -\frac{n + p}{2} \log(2 \pi) - \half \log{\sigma^{2n}} |I_n| 
		-\half \log{g^n \sigma^{2n}} |(\mX^\top \text{diag}(\vgamma) \mX)^{-1}| \\
&\quad		-\half (y - X \text{diag}(\vgamma) \vbeta)^\top \sigma^{-2} I_n (y - X \text{diag}(\vgamma) \vbeta)\\
&\quad		-\half \vbeta^\top (g \sigma^2)^{-1} (X^\top \text{diag}(\vgamma)^{-1} X) \vbeta [= -\half (g \sigma^2)^{-1} (X \vbeta)^\top \text{diag}(\vgamma)^{-1} (X \vbeta)]\\
