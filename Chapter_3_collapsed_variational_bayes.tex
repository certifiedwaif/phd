...
% VB in general
Variational Bayes minimises the KL divergence between the true posterior $p(\vy, \vtheta)$ and the 
approximating distribution $q(\vtheta)$. See \cite{Ormerod2010}.
...
approaches to model selection. In Section \cite{sec:methodology} we develop our approach. In Section
...
\section{Bayesian linear model selection}\label{sec:model_selection}
