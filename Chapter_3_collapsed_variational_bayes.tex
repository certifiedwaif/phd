...
% Background
\begin{itemize}
\item Reference other work on model selection, in a Bayesian context.
\item Zellner's g prior Zellner 1986
\item Hyper g prior Liang 2008
\item Paradoxes, reasons not to choose a fixed g. Reference Jeffrey's work 1961.
\item Variational Bayes, Explaining Variational Approximations 2010
\item Structured Variational Bayes for model selection, Wand and Ormerod Variational Bayes for Elaborate 
Distributions
\end{itemize}
% VB in general
