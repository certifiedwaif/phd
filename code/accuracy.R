...
test_accuracies_slope = function()
{
  ...
  now = Sys.time()
  var2 = zero_infl_var(mult, method="gva", verbose=TRUE)
  print(Sys.time() - now)
  print(var2)
  #now = Sys.time()
  #var2 = test_accuracy(mult, mcmc_samples, "gva")
  ...
  now = Sys.time()
  #var3 = test_accuracy(mult, mcmc_samples, "gva2")
  var3 = zero_infl_var(mult, method="gva2", verbose=TRUE)
  print(Sys.time() - now)
  ...
  var4 = zero_infl_var(mult, method="gva2new", verbose=TRUE)
  #Rprof(NULL)
  ...
  #var5 = test_accuracy(mult, mcmc_samples, "gva_nr")
  var5 = zero_infl_var(mult, method="gva_nr", verbose=TRUE)
  print(Sys.time() - now)
