...
var_accuracy3 <- calculate_accuracies("application", mult, mcmc_samples, fit3, "GVA inv param", plot_flag=TRUE)
...
var_accuracy3 <- calculate_accuracies("application2", mult, mcmc_samples, fit3, "GVA inv param", plot_flag=TRUE)
