...
x2 <- c(rep(8, 7), 19, rep(8, 3))
y4 <- c(6.58, 5.76, 7.71, 8.84, 8.47, 7.04, 5.25, 12.5, 5.56, 7.91, 6.89)

anscombe_df <- data.frame(x1 = x1, y1 = y1, y2 = y2, y3 = y3, x2 = x2, y4 = y4)
mat <- scale(anscombe_df)
anscombe_df <- data.frame(x1 = mat[, 1], y1 = mat[, 2], y2 = mat[, 3], y3 = mat[, 
    4], x2 = mat[, 5], y4 = mat[, 6])

write.table(file = "anscombes_quartet.csv", anscombe_df, row.names = FALSE, col.names = FALSE, 
    quote = FALSE, sep = ",")
