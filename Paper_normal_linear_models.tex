...
by selecting the median probability model as in \citep{Barbieri2004}. In a Bayesian context, this can be
...
To the best of our knowledge, this is a new distribution.
% \end{res}
