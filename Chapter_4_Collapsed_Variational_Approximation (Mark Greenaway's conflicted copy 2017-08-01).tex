...
\begin{figure}
\includegraphics{QLT_warm_start_covariates.pdf}
\end{figure}
...
(reference scores)
\begin{figure}
\includegraphics{QLT_warm_start_marginal_likelihood.pdf}
\end{figure}

Cold start does poorly by comparison.
\begin{figure}
\includegraphics{QLT_cold_start.pdf}
\end{figure}
...
\begin{figure}
\includegraphics{Particle_EM_high_dimensional_cold_start.pdf}
\end{figure}
