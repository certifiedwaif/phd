...
%
%==+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===
% Revised proposal.  Rolf Turner 07 February 2016. 
% To do: Include a figure and a table.
%==+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===+===
%
...
\runningheads{How I rose from the dead}{A~J~SPECKTOWSKY, P~K~DICK, \& R~TURNER}
...
\begin{figure}[htp]
\centering
\makebox{\includegraphics[width=0.95\textwidth]{ltdb}}
...
% Sat Feb 13 15:10:04 2016
\begin{table}[htp]
% The following two commented-out lines illustrate how to arrange
% for a short one-line caption to be centred. 
%\captionsetup{style=oneline}
%\caption{\label{tab:ltdb} Dingos' kidneys.}
