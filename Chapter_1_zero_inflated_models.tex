...
as is typically the case in practice. % You could calculate the difference explcitly.
...
% Table of results - Estimates, 95% credible intervals, accuracy
% I'm not at all looking forward to doing the MCMC for this
% Or resolving the overflow in mLambda in the model fit
