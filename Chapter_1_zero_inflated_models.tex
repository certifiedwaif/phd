...
resulting Gaussian posterior on the regression parameters easy to interpret. We adopt a Mean Field Variational
Bayes (VB) approach is used on the other parameters in the model.
