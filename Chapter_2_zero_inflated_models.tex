...
\begin{figure}[h]
	...
	\includegraphics[width=  \textwidth]{code/results/accuracy_plots_spline_gva2.pdf}
...
\begin{figure}[h]
	...
	\includegraphics[page=1,scale=0.45]{code/results/accuracy_plots_application_GVA_inv_param.pdf}
	\includegraphics[page=2,scale=0.45]{code/results/accuracy_plots_application_GVA_inv_param.pdf}
	\includegraphics[page=3,scale=0.45]{code/results/accuracy_plots_application_GVA_inv_param.pdf}
	\includegraphics[page=4,scale=0.45]{code/results/accuracy_plots_application_GVA_inv_param.pdf}
	\includegraphics[page=16,scale=0.45]{code/results/accuracy_plots_application_GVA_inv_param.pdf}
	\includegraphics[page=17,scale=0.45]{code/results/accuracy_plots_application_GVA_inv_param.pdf}
...
\centering
 % \includegraphics{code/results/accuracy_plots_application_biochemists_GVA_inv_param-nup.pdf}
	\includegraphics[page=1,scale=0.45]{code/results/accuracy_plots_application_biochemists_GVA_inv_param.pdf}
	\includegraphics[page=2,scale=0.45]{code/results/accuracy_plots_application_biochemists_GVA_inv_param.pdf}
	\includegraphics[page=3,scale=0.45]{code/results/accuracy_plots_application_biochemists_GVA_inv_param.pdf}
	\includegraphics[page=4,scale=0.45]{code/results/accuracy_plots_application_biochemists_GVA_inv_param.pdf}
	\includegraphics[page=5,scale=0.45]{code/results/accuracy_plots_application_biochemists_GVA_inv_param.pdf}
	\includegraphics[page=6,scale=0.45]{code/results/accuracy_plots_application_biochemists_GVA_inv_param.pdf}
...
\begin{figure}[h]
	...
	\includegraphics[page=1,scale=0.45]{code/results/accuracy_plots_application_owl_GVA_inv_param.pdf}
	\includegraphics[page=2,scale=0.45]{code/results/accuracy_plots_application_owl_GVA_inv_param.pdf}
	\includegraphics[page=3,scale=0.45]{code/results/accuracy_plots_application_owl_GVA_inv_param.pdf}
	\includegraphics[page=4,scale=0.45]{code/results/accuracy_plots_application_owl_GVA_inv_param.pdf}
	\includegraphics[page=30,scale=0.45]{code/results/accuracy_plots_application_owl_GVA_inv_param.pdf}
	\includegraphics[page=31,scale=0.45]{code/results/accuracy_plots_application_owl_GVA_inv_param.pdf}
