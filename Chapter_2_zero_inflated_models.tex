	...
	to   $n \times [m + \frac{1}{2} p (p + 1) + p \times m b]$.
			...
			\begin{table}
				\begin{tabular}{|l|rrrr|}
					...
					Covariate          & Posterior Mean & Lower 95\% CI & Upper 95\% CI & Accuracy \\
					\hline
					Satiated & -0.217 & -0.212 & -0.2144 & 97\% \\
					Arrival Time & -0.070 & -0.070 & -0.070 & 73\% \\
					Random intercept (nest) & 0.338 & & & 84\% \\
			...
			\begin{table}
				...
				\hline
				Laplace & 0.709 \\
				GVA covariance parameterisation & 5.661 \\
				GVA inverse parameterisation & 1.879 \\
				GVA fixed point & 0.177 \\
				\hline
				\end{tabular}
