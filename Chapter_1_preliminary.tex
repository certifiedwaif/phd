...
As shown by \cite{Breiman1996} and \cite{Efron2013}, while the standard formulation of a linear model is
...
\cite{Cui2008}.  This search can be driven by posterior probabilities,  \cite{Casella2006}, or by Gibbs
