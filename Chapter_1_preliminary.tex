...
This incredible increase in the volume of
...
\citep{James:2014:ISL:2517747, MacKay:2002:ITI:971143, hastie01statisticallearning, Murphy:2012:MLP:2380985}.
...
There are many models which are difficult to fit under the
...
makes Bayesian modelling  particularly appropriate for mixed and hierarchical models. Uncertainty regarding
model selection is taken into account
...
\widehat{\vnu}_O$, where $\widehat{\vnu}_O = (\mB^\top \mB + \lambda \mOmega)^{-1} \mB^\top \vy$,
...
expense of introducing some bias --- an example of the bias-- variance trade--off.
