...
Numerical analysis showing the best way to add numbers. Sort first, then add from smallest to largest.
\end{frame}
...
A good answer today is worth more than a great answer after the universe collapses back into a monobloc. Or
as I like to put it, as $t \to \infty$, you are dead.
The fast drove out the slow, even though the fast was slightly wrong.
Just shut up and do some real work!
\end{frame}
