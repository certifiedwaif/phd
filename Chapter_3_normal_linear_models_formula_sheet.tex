...
where $c=\frac{n-1}{2}$, $b = \frac{n - p - 5}{2} - a$ \\
...
Let $t = \frac{n R^2}{2 \sigma^2}$, $\frac{dt}{d\sigma^2} = -\frac{n R^2}{2 (\sigma^2)^2}$, 
$-\frac{2 (\sigma^2)^2}{nR^2} dt = d \sigma^2 = -2 \frac{n\cancel{^2} (R^2)\cancel{^2}}{(2t)^2 \cancel{n R^2}} dt$
$\sigma^2 = \frac{n R^2}{2 t}$

\begin{align*}
	I &= \int (2 \pi \frac{n R^2}{2t})^{-\frac{1}{2}} \exp(-\frac{t \alpha^2}{nR^2}) K (\frac{n R^2}{2 t})^{-(c + 1)} e^{-\frac{\cancel{n} t}{\cancel{n} R^2}} _1 F_1(b + 1, c; t) \frac{n R^2}{2 t^2} dt \\
	&= K \int n^{\frac{1}{2}} (R^2)^{\frac{1}{2}} 2^{\frac{1}{2}} t^{\frac{3}{2}} \exp{(-\frac{t(\alpha^2 + n)}{n R^2})} (\frac{n R^2}{2 t})^{-(c + 1)} _1 F_1(b + 1, c; t) dt \\
	&= K \int n^{-c-\frac{1}{2}} (R^2)^{-c-\frac{1}{2}} 2^{-c-\frac{1}{2}} t^{c + 2} \exp{(\frac{-t(\alpha^2 + n)}{n R^2})} _1 F_1(b + 1, c; t) dt
\end{align*}

Try
\[
	\int_0^\infty e^{-st} t^{\alpha'} M_{\mu, \nu} (t) dt = \frac{\alpha' + \nu + \frac{3}{2}}{(\frac{1}{2} + s)^{\alpha' + \nu + \frac{3}{2}}} _1 F_1(\alpha' + \nu + \frac{3}{2}, -\mu + \nu + \frac{1}{2}; 2v + 1; \frac{2}{2s + 1})
\]
