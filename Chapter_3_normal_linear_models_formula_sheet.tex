...
\begin{align*}
	...
	&= (2 \pi)^{-p/2} |\mV|^{-1/2} \cancel{b^a} \frac{\Gamma(p/2 + a)}{\Gamma(a)} b^{-p/2 \cancel{- a}} \left[ 1 + \frac{1}{2} (\vx - \vmu)^\top b^{-1} \mV^{-1} (\vx - \vmu) \right]^{-p/2 - a}
\end{align*}

This \emph{almost} proves what's required. We just need to manipulate the integral to include powers of $a$
